...
MODEL                   = EnergyHub_V2
MODULES                 = EnergyHub_V2_acc.c EnergyHub_V2_acc_data.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/EnergyHub_V2_acc.mexmaca64
MAKEFILE                = EnergyHub_V2.mk
MATLAB_ROOT             = /Applications/MATLAB_R2024b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2024b.app
START_DIR               = /Users/daan/Library/CloudStorage/SynologyDrive-MacBook/TU\ Delft/Master\ SET/Thesis/Matlab\ &\ Simulink
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 16
COMPUTER                = MACA64
...
MODELLIB                  = EnergyHub_V2_acc.mexmaca64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/EnergyHub_V2 \
...
EnergyHub_V2_acc.o : $(START_DIR)/slprj/accel/EnergyHub_V2/EnergyHub_V2_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/EnergyHub_V2/EnergyHub_V2_acc.c

EnergyHub_V2_acc_data.o : $(START_DIR)/slprj/accel/EnergyHub_V2/EnergyHub_V2_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/EnergyHub_V2/EnergyHub_V2_acc_data.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/EnergyHub_V2/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/EnergyHub_V2/rt_nonfinite.c
