...
MODEL                   = EnergyHub_V2
MODULES                 = rt_matrx.c rt_printf.c EnergyHub_V2.c EnergyHub_V2_capi.c EnergyHub_V2_data.c EnergyHub_V2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
PRODUCT                 = EnergyHub_V2
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/EnergyHub_V2 \
...
sfun_spid_contc.o : $(MATLAB_ROOT)/toolbox/physmod/powersys/powersys/sfun_spid_contc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/toolbox/physmod/powersys/powersys/sfun_spid_contc.c
